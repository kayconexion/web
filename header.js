  ...
  <div class="max-w-[1240px] mx-auto flex items-center justify-between px-6 py-3 gap-3">
    ...
    <div class="flex items-center gap-2 shrink-0" style="flex-wrap:nowrap;">
      ...
      <div class="hidden md:flex items-center gap-1.5 shrink-0">
        ...
        <a href="https://www.instagram.com/kayconexion" target="_blank" class="w-8 h-8 rounded-full bg-white/10 border border-white/15 flex items-center justify-center text-white hover:bg-[#FFC53A] hover:text-[#20365b] transition" title="Instagram">
    ...
    <div class="p-6">
      ...
      <div class="mt-8 space-y-3">
        ...
        <div class="flex items-center gap-2 pt-4 border-t border-white/10">
          ...
          <a href="https://www.instagram.com/kayconexion" target="_blank" class="w-10 h-10 rounded-full bg-white/10 border border-white/15 grid place-items-center text-white hover:bg-[#FFC53A] hover:text-[#20365b] transition"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.2c3.2 0 3.6 0 4.9.1 1.2.1 1.8.3 2.2.5.5.2.9.5 1.3.9.4.4.7.8.9 1.3.2.4.4 1 .5 2.2.1 1.3.1 1.7.1 4.9s0 3.6-.1 4.9c-.1 1.2-.3 1.8-.5 2.2-.2.5-.5.9-.9 1.3-.4.4-.8.7-1.3.9-.4.2-1 .4-2.2.5-1.3.1-1.7.1-4.9.1s-3.6 0-4.9-.1c-1.2-.1-1.8-.3-2.2-.5a3.5 3.5 0 01-1.3-.9 3.5 3.5 0 01-.9-1.3c-.2-.4-.4-1-.5-2.2C2.2 15.6 2.2 15.2 2.2 12s0-3.6.1-4.9c.1-1.2.3-1.8.5-2.2.2-.5.5-.9.9-1.3.4-.4.8-.7 1.3-.9.4-.2 1-.4 2.2-.5C8.4 2.2 8.8 2.2 12 2.2z"/></svg></a>
          <a href="https://wa.me/41764421370" target="_blank" class="w-10 h-10 rounded-full bg-[#FFC53A] grid place-items-center text-[#20365b] hover:scale-105 transition"><svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M19.05 4.91A9.82 9.82 0 0012.04 2C6.53 2 2.04 6.5 2.04 12.01c0 1.76.46 3.48 1.33 5L2 22l5.16-1.35a9.8 9.8 0 004.88 1.31h.01c5.5 0 10-4.5 10-10.01a9.75 9.75 0 00-2.9-6.94z"/></svg></a>
        </div>
      </div>
    </div>
  </div>
